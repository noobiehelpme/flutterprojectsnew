...
import 'package:vrd_ui/responsive/res_layout.dart';

class TabletLoginPage extends StatefulWidget {
  TabletLoginPage({super.key});
                        ...
                        children: [
                          Container(
                            ...
                            child: const Image(
                              ...
                              // child: Image.asset('assets/images/macom.png'),
                            ),
                          ),
                          const Padding(
                                  ...
                                  if (response is EmployeeModel) {
                                    ...
                                    Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                            builder: (BuildContext context) =>
                                                ResponsiveLayout(
                                                   desktopBody: SearchTabView(employeeModel: response), mobileBody: SearchTabView(employeeModel: response), tabletBody:  SearchTabView(employeeModel: response,),)));
                                  } else {
